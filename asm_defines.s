...
.equ MOVE_STONEAXE, 0x2E4
.equ MOVE_CEASELESSEDGE, 0x2E5
.equ MOVE_CHLOROBLAST, 0x2E6
.equ MOVE_ESPERWING, 0x2E7
.equ MOVE_HEADLONGRUSH, 0x2E8
.equ MOVE_INFERNALPARADE, 0x2E9
.equ MOVE_RAGINGFURY, 0x2EA
.equ MOVE_WAVECRASH, 0x2EB
.equ MOVE_PSYSHIELDBASH, 0x2EC
.equ MOVE_BLEAKWINDSTORM, 0x2ED
.equ MOVE_DIRECLAW, 0x2EE

.equ MOVE_BREAKNECK_BLITZ_P, 0x2EF
.equ MOVE_BREAKNECK_BLITZ_S, 0x2F0
.equ MOVE_ALL_OUT_PUMMELING_P, 0x2F1
.equ MOVE_ALL_OUT_PUMMELING_S, 0x2F2
.equ MOVE_SUPERSONIC_SKYSTRIKE_P, 0x2F3
.equ MOVE_SUPERSONIC_SKYSTRIKE_S, 0x2F4
.equ MOVE_ACID_DOWNPOUR_P, 0x2F5
.equ MOVE_ACID_DOWNPOUR_S, 0x2F6
.equ MOVE_TECTONIC_RAGE_P, 0x2F7
.equ MOVE_TECTONIC_RAGE_S, 0x2F8
.equ MOVE_CONTINENTAL_CRUSH_P, 0x2F9
.equ MOVE_CONTINENTAL_CRUSH_S, 0x2FA
.equ MOVE_SAVAGE_SPIN_OUT_P, 0x2FB
.equ MOVE_SAVAGE_SPIN_OUT_S, 0x2FC
.equ MOVE_NEVER_ENDING_NIGHTMARE_P, 0x2FD
.equ MOVE_NEVER_ENDING_NIGHTMARE_S, 0x2FE
.equ MOVE_CORKSCREW_CRASH_P, 0x2FF
.equ MOVE_CORKSCREW_CRASH_S, 0x300
.equ MOVE_INFERNO_OVERDRIVE_P, 0x301
.equ MOVE_INFERNO_OVERDRIVE_S, 0x302
.equ MOVE_HYDRO_VORTEX_P, 0x303
.equ MOVE_HYDRO_VORTEX_S, 0x304
.equ MOVE_BLOOM_DOOM_P, 0x305
.equ MOVE_BLOOM_DOOM_S, 0x306
.equ MOVE_GIGAVOLT_HAVOC_P, 0x307
.equ MOVE_GIGAVOLT_HAVOC_S, 0x308
.equ MOVE_SHATTERED_PSYCHE_P, 0x309
.equ MOVE_SHATTERED_PSYCHE_S, 0x30A
.equ MOVE_SUBZERO_SLAMMER_P, 0x30B
.equ MOVE_SUBZERO_SLAMMER_S, 0x30C
.equ MOVE_DEVASTATING_DRAKE_P, 0x30D
.equ MOVE_DEVASTATING_DRAKE_S, 0x30E
.equ MOVE_BLACK_HOLE_ECLIPSE_P, 0x30F
.equ MOVE_BLACK_HOLE_ECLIPSE_S, 0x310
.equ MOVE_TWINKLE_TACKLE_P, 0x311
.equ MOVE_TWINKLE_TACKLE_S, 0x312

.equ MOVE_CATASTROPIKA, 0x313
.equ MOVE_10000000_VOLT_THUNDERBOLT, 0x314
.equ MOVE_STOKED_SPARKSURFER, 0x315
.equ MOVE_EXTREME_EVOBOOST, 0x316
.equ MOVE_PULVERIZING_PANCAKE, 0x317
.equ MOVE_GENESIS_SUPERNOVA, 0x318
.equ MOVE_SINISTER_ARROW_RAID, 0x319
.equ MOVE_MALICIOUS_MOONSAULT, 0x31A
.equ MOVE_OCEANIC_OPERETTA, 0x31B
.equ MOVE_SPLINTERED_STORMSHARDS, 0x31C
.equ MOVE_LETS_SNUGGLE_FOREVER, 0x31D
.equ MOVE_CLANGOROUS_SOULBLAZE, 0x31E
.equ MOVE_GUARDIAN_OF_ALOLA, 0x31F
.equ MOVE_SEARING_SUNRAZE_SMASH, 0x320
.equ MOVE_MENACING_MOONRAZE_MAELSTROM, 0x321
.equ MOVE_LIGHT_THAT_BURNS_THE_SKY, 0x322
.equ MOVE_SOUL_STEALING_7_STAR_STRIKE, 0x323
...
.equ SPECIES_WYRDEER, 0x4F4
.equ SPECIES_KLEAVOR, 0x4F5
.equ SPECIES_URSALUNA, 0x4F6
.equ SPECIES_BASCULEGION, 0x4F7
.equ SPECIES_SNEASLER, 0x4F8
.equ SPECIES_OVERQWIL, 0x4F9
.equ SPECIES_ENAMORUS, 0x4FA

.equ SPECIES_ENAMORUS_THERIAN, 0x4FB

.equ SPECIES_GROWLITHE_H, 0x4FC
.equ SPECIES_ARCANINE_H, 0x4FD
.equ SPECIES_VOLTORB_H, 0x4FE
.equ SPECIES_ELECTRODE_H, 0x4FF
.equ SPECIES_TYPHLOSION_H, 0x500
.equ SPECIES_QWILFISH_H, 0x501
.equ SPECIES_SNEASEL_H, 0x502
.equ SPECIES_SAMUROTT_H, 0x503
.equ SPECIES_LILLIGANT_H, 0x504
.equ SPECIES_ZORUA_H, 0x505
.equ SPECIES_ZOROARK_H, 0x506
.equ SPECIES_BRAVIARY_H, 0x507
.equ SPECIES_SLIGGOO_H, 0x508
.equ SPECIES_GOODRA_H, 0x509
.equ SPECIES_AVALUGG_H, 0x50A
.equ SPECIES_DECIDUEYE_H, 0x50B

.equ SPECIES_ARSELLOSKY, 0x50C
.equ SPECIES_EVALEON, 0x50D
.equ SPECIES_AEREON, 0x50E
.equ SPECIES_CONTAGEON, 0x50F
.equ SPECIES_LANEON, 0x510
.equ SPECIES_SCALEON, 0x511

.equ SPECIES_GOLEM_F, 0x512
.equ SPECIES_CLOYSTER_F, 0x513
.equ SPECIES_SHUCKLE_F, 0x514
.equ SPECIES_SKARMORY_F, 0x515
.equ SPECIES_BRELOOM_F, 0x516
.equ SPECIES_GIGALITH_F, 0x517
.equ SPECIES_WOOLOO_F, 0x518
.equ SPECIES_DUBWOOL_F, 0x519

.equ SPECIES_WIGGLYTUFF_MEGA, 0x51A
.equ SPECIES_STARMIE_MEGA, 0x51B
.equ SPECIES_MEGANIUM_MEGA, 0x51C
.equ SPECIES_DUNSPARCE_MEGA, 0x51D
.equ SPECIES_FLYGON_MEGA, 0x51E
.equ SPECIES_MILOTIC_MEGA, 0x51F
.equ SPECIES_CHIMECHO_MEGA, 0x520
.equ SPECIES_TORTERRA_MEGA, 0x521
.equ SPECIES_EMPOLEON_MEGA, 0x522
.equ SPECIES_VESPIQUEN_MEGA, 0x523
.equ SPECIES_DUSKNOIR_MEGA, 0x524
.equ SPECIES_FROSLASS_MEGA, 0x525
.equ SPECIES_KLINKLANG_MEGA, 0x526
.equ SPECIES_HAXORUS_MEGA, 0x527
.equ SPECIES_HYDREIGON_MEGA, 0x528
.equ SPECIES_DELPHOX_MEGA, 0x529
.equ SPECIES_AURORUS_MEGA, 0x52A

.equ SPECIES_OCTILLERY_F, 0x52B
